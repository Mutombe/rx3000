...
// 645 KB, and it used to be imported by `main.tsx`, which every
// portal loads too. A patient opening a link from an SMS on a
// Zimbabwean mobile connection downloaded the whole dispensary to
// find out whether their tablets were ready. It belongs to the
// staff application, so it is imported by the staff application.
import "./styles.css";
...
const DispensaryOperations = lazy(() => import("./pages/DispensaryOperations"));
          ...
          <Protected>
            <Layout>
              ...
              <Routes>
                ...
                <Route path="/dispensary/operations" element={<DispensaryOperations />} />
