...
export default function Ledger() {
  ...
  return (
    <div className="page">
      ...
      {/* Lifted into a component so Reconciliation can show the same screen.
          It stays here too: an accountant closing a month works down the
          ledger's tabs and should not be sent somewhere else halfway. */}
      {tab === "bank" && <BankReconcile />}
    </div>
  );
}
